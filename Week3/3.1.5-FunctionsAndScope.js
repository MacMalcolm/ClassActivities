...
console.log(addNumbersFrom1To100());        //returns 5050

// try to print the variable "total" outside the function
// ? what do you expect ? I think it will be undefined or throw error as the variable is not global.
console.log(total);
...
function parentAndChildScope() {
  ...
  console.log("Parent Scope, Child Variable:", childVariable);      // This console log will not print due to unaccessable variable
}