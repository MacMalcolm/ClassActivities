...
let favoriteSong = "This girl by Cooking on Three Burners";
...
let favoriteThing = true;
console.log(typeof favoriteThing);

favoriteSong = "Medusa by Griz";
...
console.log("I'm glad I discovered " + favoriteSong + "or my name isn't " + name1);
