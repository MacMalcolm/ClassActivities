...
const data = [
  ...
  const pairs = [];
  data.forEach(user => pairs.push(user.address.geo));
  console.log(pairs);
  ...
  const catchPhraseAndBs = [];
  
  data.forEach(curr => catchPhraseAndBs.push(`${curr.company.catchPhrase} to ${curr.company.bs}`));
  console.log(catchPhraseAndBs);
