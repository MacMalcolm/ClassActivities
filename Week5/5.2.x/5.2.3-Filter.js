...
const data = [
  ...
  // const user6TasksComplete = user6Tasks.filter( tasks => user.complete === true);
  
  // filter for tasks with a title less than 24 characters long
  const lilTitle = data.filter( title => title.title.length < 24); // Strings need 'length' added. JS knows that object is string
  console.log(lilTitle);